...
/* ============================================================
   ...
   Live: /api/send-email through Resend. Two-step confirm on every
   send, and the server refuses without confirm:true regardless —
   the rule is enforced twice, in the UI and in the function.
